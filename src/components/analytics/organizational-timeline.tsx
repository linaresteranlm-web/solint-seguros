...
function classFor(type: TimelineEvent["type"]) {
  ...
  if (type === "danger") return "bg-red-100 text-red-700 solint-glow";
      ...
      <section className="rounded-[1.7rem] border border-slate-200 bg-white p-6 shadow-[0_18px_50px_rgba(15,23,42,0.08)]">
        ...
        <div className="space-y-4">
          {events.map((event, index) => {
            ...
            return (
              <MotionReveal key={event.id} delay={index * 120}>
                <div className="relative flex gap-4">
                  ...
                  <div className="flex-1 rounded-2xl border border-slate-200 bg-slate-50 p-4 transition duration-300 hover:-translate-y-1 hover:bg-white hover:shadow-lg">
