...
import { MotionReveal, AnimatedCounter } from "@/components/analytics/motion-ui";
        ...
        <div className="p-6">
          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {trends.trends.map((trend, index) => {
              ...
              return (
                <MotionReveal key={trend.label} delay={index * 90}>
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 transition duration-300 hover:-translate-y-1 hover:bg-white hover:shadow-lg">
                    <div className="flex items-start justify-between gap-3">
                      <div>
                        ...
                        <p className="mt-2 text-3xl font-black text-[#04224a]">
                          <AnimatedCounter value={trend.current} />
                        </p>
                      </div>
